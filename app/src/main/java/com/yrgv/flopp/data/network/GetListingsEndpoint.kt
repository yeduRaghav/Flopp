...
/**
 * Endpoint returns a page of Listings
 */
class GetListingsEndpoint constructor(private val api: ApiService) {
        ...
        Single.just(api.getListings(page))
            ...
            .subscribe { apiResponse, exception ->
                ...
                apiResponse.body()?.let {
                    ...
                    val localException = ApiError.getLocalizedErrorResponse(
                        apiResponse.code(),
